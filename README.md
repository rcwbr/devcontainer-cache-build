...
`"initializeCommand": "curl https://raw.githubusercontent.com/rcwbr/devcontainer-cache-build/0.9.1/devcontainer-cache-build-initialize | bash"`
...
curl https://raw.githubusercontent.com/rcwbr/devcontainer-cache-build/0.9.1/devcontainer-cache-build-initialize | bash
```
...
jobs:
  devcontainer-cache-build:
    uses: >-
      rcwbr/devcontainer-cache-build/.github/workflows/devcontainer-cache-build.yaml@0.9.1
    permissions:
      packages: write
```
...
docker buildx bake -f github-cache-bake.hcl -f cwd://docker-bake.hcl https://github.com/rcwbr/dockerfile-partials.git#0.9.1
```
